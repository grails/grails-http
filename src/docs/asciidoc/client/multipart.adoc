To send a request of type `application/x-www-form-urlencoded` use the `form` method defined by link:groovydoc/grails/http/client/builder/HttpRequestBuilder.html[HttpRequestBuilder]:
